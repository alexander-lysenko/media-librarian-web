...
export const LibraryTable = () => {
  ...
  const [rowsPerPageOptions, setRowsPerPageOptions] = React.useState<RowsPerPageOptions>([5, 10, 25]);
      ...
      <Paper sx={{ width: "100%", mb: 2 }}>
        <TableContainer>
          <Table sx={{ minWidth: 750 }} aria-labelledby="tableTitle" size="small">
            <TableHead>
              <TableRow>
                <TableCell sortDirection="asc">1</TableCell>
                <TableCell>2</TableCell>
                <TableCell>3</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
              <TableRow hover selected onClick={(e) => console.log(e)}>
                <TableCell>1</TableCell>
                <TableCell>2</TableCell>
                <TableCell>
                  <Rating readOnly max={10} value={5} size={"small"} />
                </TableCell>
              </TableRow>
              <TableRow hover onClick={(e) => console.log(e)}>
                <TableCell>1</TableCell>
                <TableCell>2</TableCell>
                <TableCell>
                  <Rating readOnly max={10} value={4} size={"small"} />
                </TableCell>
              </TableRow>
            </TableBody>
          </Table>
        ...
        <TablePagination
          ...
          page={page}
          rowsPerPage={rowsPerPage}
          rowsPerPageOptions={detectAvailableRowsPerPageOptions(movies.length, t("common.all"))}
          onPageChange={handleChangePage}
          onRowsPerPageChange={handleChangeRowsPerPage}
